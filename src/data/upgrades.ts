...
export const UPGRADES: UpgradeDef[] = [
  {
    ...
    name: 'Motor',
    emoji: '⚙️',
    beschreibung: 'Höhere Endgeschwindigkeit',
    statLabel: 'Tempo',
    color: '#ff7a2f',
    maxLevel: 5,
  ...
  },
  {
    ...
    name: 'Reifen',
    emoji: '🛞',
    beschreibung: 'Bessere Kurvenkontrolle',
    statLabel: 'Kontrolle',
    color: '#3fc1ff',
    maxLevel: 5,
  ...
  },
  {
    ...
    name: 'Booster',
    emoji: '🚀',
    beschreibung: 'Schnellere Beschleunigung',
    statLabel: 'Boost',
    color: '#b56bff',
    maxLevel: 5,
  ...
  },
  {
    ...
    name: 'Panzer',
    emoji: '🛡️',
    beschreibung: 'Weniger Tempoverlust bei Rempeln',
    statLabel: 'Schutz',
    color: '#36e07a',
    maxLevel: 5,
